...
tale traduzione e' eseguito da un programma detto \textbf{compilatore}.\\
...
di \textbf{underflow}, dovuti alle operazioni matematiche che come
risultato presentano un numero non codificabile in binario nei bit
a disposizione della macchina. \\\textbf{ Chiusura:} una coppia di
ambiente e espressione in cui questa dev'essere valutata. L'ambiente
deve comprendere (almeno) tutte le variabili libere dell'espressione.
...
\textbf{run-time }o il \textbf{compile-time. }
...
\bibitem{key-5} Integrazione con: \url{http://www.dmi.unict.it/~barba/Architetture.html/MATERIALE-IN-RETE/MA/implementazione.htm}
\end{thebibliography}
