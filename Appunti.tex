...
\textbf{stack overflow}. Esiste una variante chiamata \textbf{ricorsione
in coda}, la quale consiste nel chiamare la funzione che ritorna il
valore senza fare ulteriori computazioni. \\\textbf{ Iterazione:}
si realizza quando si eseguono più righe di codice al verificarsi
di una determinata condizione. Esistono due tipi di iterazione: \begin{enumerate}\item
